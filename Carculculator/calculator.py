...
class Car:
    ...
    def dynamic_year_cost(self, milage: int):
        return self.fuel_economy * milage / 100 * get_gas_price()
...
class ElectricCar(Car):
    def __init__(self, name: str, price: int, insurance_cost: int,
        ...
        self.power_consumption = power_consumption # wt / km

    def dynamic_year_cost(self, milage: int, ):
        return self.power_consumption * milage / 1000 * get_power_price()
